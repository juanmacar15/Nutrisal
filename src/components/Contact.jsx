            ...
            <section class="text-gray-600 body-font mb-[20px]">
                <div class="container px-5 mx-auto">
                    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        ...
                        <button class="flex mx-auto mt-16 text-white bg-[#00c022] border-0 py-2 px-8 focus:outline-none hover:bg-[#289e2a] rounded text-lg hover:scale-125 duration-500"><a href={`https://wa.me/573217580062/?text=Buenas,%20tienes%20sal%20mineralizada%20disponible?`} target='_blank'>Adquirir producto</a></button>
                    </div>
                </div>
            </section>
        </>
